...
<script src="{{url('/')}}/assets/admin/users/js/manage.js?v={{time()}}" type="text/javascript"></script>
...
globals.modules.attach(users);
</script>
@endpush

@section('content')
<div class="container-xl" id="users_page">
    <!--Page header-->
                            ...
                            <table class="table table-vcenter table-mobile-md card-table">
                                ...
                                <tbody>
                                    <tr v-for="(row, indx) in rows">
                                        ...
                                        <td data-label="Name">
                                            <div class="d-flex py-1 align-items-center">
                                                ...
                                                <div class="flex-fill">
                                                    ...
                                                    <div class="text-muted"><a href="#" class="text-reset">@{{row.profile}}</a></div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-muted" data-label="Contact">
                                            <p class="text-primary mb-1 pb-0">@{{row.email}}</p>
                                            <p class="text-warning mb-1 pb-0">@{{row.mobile}}</p>
                                        </td>
                                        <td class="text-muted" data-label="Status">@{{row.status_text}}</td>
